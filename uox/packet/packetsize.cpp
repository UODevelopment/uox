...
//======================================================================
PacketSize::PacketSize(const ClientVersion &version) :PacketSize(){
    this->update(version);
}
//======================================================================
auto PacketSize::update(const ClientVersion &version) ->void {
...
//======================================================================
auto PacketSize::sizeFor(packetid_t id) -> int {
