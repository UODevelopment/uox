...
namespace util {
    ...
    //======================================================================
    Buffer::Buffer( const Buffer &value):Buffer() {
        this->data = value.data ;
        this->extend = value.extend ;
        this->offset = value.offset ;
    }
    //======================================================================
    Buffer::Buffer( Buffer &&value):Buffer() {
        std::swap(data,value.data) ;
        value.extend = std::exchange(this->extend, value.extend);
        value.offset = std::exchange(this->offset,value.offset);
    }
    //======================================================================
    Buffer::Buffer( const std::vector<std::uint8_t> &value) {
        this->data = value ;
        extend = true ;
        offset = 0 ;
    }
    //======================================================================
    Buffer::Buffer( std::vector<std::uint8_t> &&value) {
        std::swap(this->data,value);
        extend = true ;
        offset = 0 ;
    }
    //======================================================================
    ...
    //======================================================================
    auto Buffer::dump(std::ostream &output) const  ->void {
        ::util::dump(output, data.data(), data.size(),16,16) ;
    }
    //======================================================================
